...
def train_gatv2_model(model, node_features, edge_index, config, **kwargs):
    """
    Train GATv2 model - Uses the same training strategy as GNN-KAN
    ...
    """
    print("Starting GATv2 model training...")
    ...
    print(f"GATv2 training completed, final loss: {training_history['loss'][-1]:.6f}")
