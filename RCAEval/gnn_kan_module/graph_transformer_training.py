"""
Graph Transformer Training Module
...
def train_graph_transformer_model(model, node_features, edge_index, config, **kwargs):
    """
    Train Graph Transformer model - Uses the same training strategy as GNN-KAN
    ...
    """
    print("Starting Graph Transformer model training...")
    ...
    # Learning rate scheduler (same as GNN-KAN)
    ...
    print(f"Graph Transformer training completed, final loss: {training_history['loss'][-1]:.6f}")
